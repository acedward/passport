// Deploy-or-connect helpers for witness-free contracts, plus a generic callTx wrapper.
// Copied from the project's Gate 0 spike (experiments/c2c-mint-claim-spike/src/node/
// setup.ts) with the witness-bearing variants dropped — this package's only contracts are
// the vault and the Signet singleton, and BOTH are witness-free.
//
